(function(){/*
  ...
  */
  function showOperationMessage(opr, a, b){
    return 'A operação '+ a +' '+ opr +' '+ b +' ='
  }
  ...
  */
  operationSignal = ';'
  var semicolon = calculator(operationSignal)
  if (semicolon) {
    number1 = 10
    number2 = 10

    console.log(showOperationMessage(operationSignal, number1, number2), semicolon(number1, number2))
  }
  else {
    console.log(showErrorMessage(operationSignal))
  }
