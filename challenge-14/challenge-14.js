(function(){
  ...
  */
  ...
  numberObjects.indexOf(numberObjects[1]) > -1 ? console.log('Existe um objeto { number: 2 } em numberObjects!') : console.log('Não existe um objeto { number: 2 } em numberObjects :(')
  ...
  */
  ...
  numberObjects.lastIndexOf(numberObjects[1]) > -1 ? console.log('Existe um objeto { number: 2 } em numberObjects!') : console.log('Não existe um objeto { number: 2 } em numberObjects :(')
